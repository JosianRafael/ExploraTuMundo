  ...
  return (
    ...
    >
      <div className="w-full md:w-[800px] xl:w-[900px] flex flex-col justify-center items-center pt-16 md:pt-16 lg:pt-20 text-center">
        ...
        >
          <div className="text-7xl sm:text-6xl lg:text-5xl xl:text-7xl font-bold tracking-wide  text-primaryText  px-8 sm:px-8 md:px-20 lg:px-4">
            <h1 className="inline md:hidden">¡Embárcate en un viaje!</h1>
            <h1 className="hidden md:inline">"¡Embárcate en un viaje de descubrimiento sin fin!"</h1>
          </div>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 10 }}
        ...
        >
          ...
          Sumérgete en el aprendizaje y entretenimiento como nunca antes.
          </h2>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 10 }}
