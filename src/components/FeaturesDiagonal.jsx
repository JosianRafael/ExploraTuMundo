      ...
      >
        <div className=" 2xl:w-[1150px] xl:w-[1050px]  md:w-4/5 flex justify-center bg-bgDark1 pt-12 lg:pt-24 pb-8 lg:pb-20 mx-auto lg:flex-row flex-col">
          <div className="w-3/4 lg:w-1/2 flex flex-col lg:mx-unset mx-auto">
            <span className="block-subtitle">Genera ingresos</span>
            <h2 className="mt-10 mb-8 text-4xl lg:text-5xl block-big-title">
              Educacion Financiera
            </h2>
            <p className="mb-16 text-secondaryText leading-loose">
            Descubre el poder de la educación financiera y toma el control de tu futuro económico. Nuestra plataforma te ofrece herramientas y recursos interactivos para aprender sobre inversiones, ahorro, presupuestos y más. 
            </p>
            <a
              className="w-[210px] h-12 contained-button mr-10 "
              href="/Finanzasdigitales"
            >
              Get Started
            </a>
          </div>
