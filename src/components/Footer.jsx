...
const footerData = [
  {
    title: "Products",
    items: ["Home", "Programacion", "Finanzas Digitales", "Musica"],
  },
  {
        ...
        <div className="container mx-auto px-4 w-4/5 md:w-11/12 lg:w-10/12 xl:w-4/5 2xl:w-2/3">
          <div className="flex flex-wrap">
            <div className="w-full lg:w-1/3 mb-16 lg:mb-0">
              ...
              Explora nuevos conocimientos, aprende de manera interactiva y crece con cada experiencia. Aquí, cada clic es una oportunidad de descubrir algo nuevo.
              </p>
